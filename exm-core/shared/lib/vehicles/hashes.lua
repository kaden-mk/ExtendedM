...
ExtendedM.VehicleHashes = {
    ...
    ZR3803 = -1478704292,
    ZTYPE = 758895617,
    eDLC_BIG_YACHT_MODEL = 1839342828,
    eDLC_BIG_TRUCK_MODEL = -2001931270,
    eDLC_BALLISTIC_EQUIPMENT_MODEL = -318350279,
    eDLC_BIG_PLANE_MODEL = 1104419872,
    eDLC_HACKER_TRUCK_MODEL = -1254486082
}